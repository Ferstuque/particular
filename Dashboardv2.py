...
anos = sorted(dados['Data da Compra'].dt.year.dropna().unique())
lista_anos = ['Todos'] + anos
ano_selecionado = st.sidebar.selectbox('Ano', lista_anos)

# Filtrar os dados pelo estado selecionado (se não, para "Todos")
if ano_selecionado != 'Todos':
    dados = dados[dados['Data da Compra'].dt.year == ano_selecionado]

# Criar uma lista de estados para multiseleção
